import model_lstm_with_grid_search
import re
import pandas as pd
...
for input_file_name in list_of_dates:
    ...
    training_time_of_one_model= model_lstm_with_grid_search.lstm_forecasts(input_filename, date_range)
...
training_time_df.to_csv(f"../forecasting_results/lstm_results/training_time.csv", index=False)