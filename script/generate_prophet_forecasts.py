import model_prophet_with_grid_search
import re
import pandas as pd
...
for input_file_name in list_of_dates:
    ...
    training_time_of_one_model = model_prophet_with_grid_search.prophet_forecasts(input_filename, date_range)
...
training_time_df.to_csv("../forecasting_results/prophet_results/training_time.csv", index=False)
